...
const SW_VERSION = 'v39'; // v30 -> v31: módulo Emergencia completo (antes solo Inspecciones) + librerías CDN que usa, precacheados desde la instalación — antes dependían de haber visitado cada página online al menos una vez
